    ...
    return new Promise((resolve, reject) => {
        ...
        reviews = reviews.map(review => {
            return {
                ...
                text: `Hotel Is Very beautiful and clean. expensive but nice experience to stay this hotel.
                       Excellent service or excellent management.
                       More tasty and delicious dinner. the food after fresh or pure and healthy.`,
