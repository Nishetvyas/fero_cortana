...
// // bot.dialog('/', function(session){2
// //     //  console.log("are u in welcome intent");
// //       session.send("hello welcome to /");
// // });
//
// //=========================================================
// // Bots Dialogs
...
//
//
// var model = 'https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/19b7ec86-9f4e-4adb-b0d0-5575d1240908?verbose=true&';
// var recognizer = new builder.LuisRecognizer(model);
// bot.recognizer(recognizer);
//
// bot.dialog('/welcome_intent', [
//     function (session) {
//         session.sendTyping();
//         builder.Prompts.text(session, 'hey welcoem');
//     },
...
// // bot.recognizer(recognizer);
// // bot.dialog('welcome_intent', function(session){
// //       console.log("are u in welcome intent");
